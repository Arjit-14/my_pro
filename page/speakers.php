    ...
    <div class="container mt-3 ">
        <div class="about-innar-content committees">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-10">
                        ...
                        <p class="read-more" id="readMoreText5">
                            ...
                            He has contributed several research publications in international conference proceedings and journals, showcasing his dedication to advancing the field of AI and Intelligent Systems through rigorous academic research. These publications highlight his deep understanding of cutting-edge technologies and his ability to contribute valuable insights to the scientific community. Danish research contributions further validate his expertise and thought leadership making him a respected expert in the field.
                        </p>
                        <br>
                        <span id="readMoreButton5">
                            Read More
                        </span>
                        <script src="assets/js/script.js"></script>
                    </div>
            ...
            <div class="container m-3">
                <div class="row align-items-center">
                    <div class="col-md-2">
                        <img style="margin-left: 30px;width:70%;" src="https://backends.it.ntnu.no/user-profile-service/rest/files/377336ef-2f78-3586-93f8-659c049c9a85">
                    </div>
                    <div class="col-md-10">
                        <h1><a style="color: #005388;" href="https://scholar.google.com/citations?hl=en&user=KH3nAwIAAAAJ" target="_blank">Prof. Ottar Laurits Osen</a></h1>
                        <p>Department of ICT and Natural Sciences,<br>
                            NTNU, Norway</p>
                        <br>
                        <p class="read-more" id="readMoreText8">
                            Currently a Professor at the study program in Automation in Ålesund. My interests include industrial control systems, intelligent systems, micro-controllers, technical safety (SIL), and pedagogics, specifically problem-based and project-based learning.
                            I teach courses on industrial control systems, instrumentation, cybernetics, intelligent systems (artificial intelligence), simulations, and micro-controllers, and I also mentor B.Sc. and M.Sc. theses.
                            My experience spans automation for vessels and offshore installations, control systems for vessels, production processes, and subsea. I have also developed software for databases and CNC machines. I have participated in large offshore projects such as Snorre A, Troll C, Petrojarl Foinaven, and Heidrun, and I have experience as a project manager and coordinator for a H2020 application.
                        </p>
                        <br>
                        <span id="readMoreButton8">
                            Read More
                        </span>
                        <script src="assets/js/script.js"></script>
                    </div>
            ...
            <div class="container m-3">
                <div class="row align-items-center">
                    <div class="col-md-2">
                        <img style="margin-left: 30px;width:70%;" src="https://backends.it.ntnu.no/user-profile-service/rest/files/6375c1c4-bde5-3ad1-aec4-7b8a5123edd0">
                    </div>
                    <div class="col-md-10">
                        <h1><a style="color: #005388;" href="https://scholar.google.com/citations?user=l2VzMk4AAAAJ&hl=en&oi=sra" target="_blank">Prof. Vijander Singh</a></h1>
                        <p>Department of ICT and Natural Sciences,<br>
                            NTNU, Norway</p>
                        <br>
                        <p class="read-more" id="readMoreText9">

                        </p>
                        <br>
                        <span id="readMoreButton9">
                            Read More
                        </span>
                        <script src="assets/js/script.js"></script>
                    </div>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-10">
                        ...
                        <p>Free University of Bozen-Bolzano,<br>
                            ITALY</p>
                        <br>
                        <p class="read-more" id="readMoreText11">
                            Professor Valliappan Raju specializes in research methodology and spearheads Research division at Perdana University, Malaysia. In his 20+ years of experience, he has served over 18 years in Higher Education institutions in Botswana, India and Malaysia. He holds visiting positions in the Czech Republic, Thailand and Germany. As per ResearchGate statistics, he has published 256 manuscripts, the majority in FinTech discipline indexed in Scopus, SSCI, EI indexed journals. Under his supervision, 63 candidates have graduated with Ph.D. degrees. Vally was instrumental in developing Ph.D. programs in his prior assignments. He is frequently invited to deliver lectures on research, industry 5.0, digital marketing, crypto banking and entrepreneurship. He actively reviews World Bank Conference Journals (USA). He holds two patents. Vally is the founder/editor of Journal of Reproducible Research. Vally’s book ‘Fundamentals of Thesis’ was well received among the research community. He has secured research grants from public and private institutions worth USD $250,000+ as on 2022. As a passionate researcher his interests remain in Anthropology, research methodology, data analytics and FinTech research.
                        </p>
                        <br>
                        <span id="readMoreButton11">
                            Read More
                        </span>
                        <script src="assets/js/script.js"></script>
                    </div>
...
<script>
    ...
    const readMoreText3 = document.getElementById("readMoreText3");

    readMoreButton3.addEventListener("click", function() {
        if (readMoreText3.style.display === "none" || readMoreText3.style.display === "") {
            readMoreText3.style.display = "block";
...
<script>
    const readMoreButton4 = document.getElementById("readMoreButton4");
    const readMoreText4 = document.getElementById("readMoreText4");

    readMoreButton4.addEventListener("click", function() {
        if (readMoreText4.style.display === "none" || readMoreText4.style.display === "") {
            readMoreText4.style.display = "block";
            readMoreButton4.textContent = "Read Less";
        } else {
            readMoreText4.style.display = "none";
            readMoreButton4.textContent = "Read More";
        }
    });
</script>

<script>
    const readMoreButton5 = document.getElementById("readMoreButton5");
    const readMoreText5 = document.getElementById("readMoreText5");

    readMoreButton5.addEventListener("click", function() {
        if (readMoreText5.style.display === "none" || readMoreText5.style.display === "") {
            readMoreText5.style.display = "block";
            readMoreButton5.textContent = "Read Less";
        } else {
            readMoreText5.style.display = "none";
            readMoreButton5.textContent = "Read More";
        }
    });
</script>

<script>
    const readMoreButton6 = document.getElementById("readMoreButton6");
    const readMoreText6 = document.getElementById("readMoreText6");

    readMoreButton6.addEventListener("click", function() {
        if (readMoreText6.style.display === "none" || readMoreText6.style.display === "") {
            readMoreText6.style.display = "block";
            readMoreButton6.textContent = "Read Less";
        } else {
            readMoreText6.style.display = "none";
            readMoreButton6.textContent = "Read More";
        }
    });
</script>

<script>
    const readMoreButton7 = document.getElementById("readMoreButton7");
    const readMoreText7 = document.getElementById("readMoreText7");

    readMoreButton7.addEventListener("click", function() {
        if (readMoreText7.style.display === "none" || readMoreText7.style.display === "") {
            readMoreText7.style.display = "block";
            readMoreButton7.textContent = "Read Less";
        } else {
            readMoreText7.style.display = "none";
            readMoreButton7.textContent = "Read More";
        }
    });
</script>

<script>
    const readMoreButton8 = document.getElementById("readMoreButton8");
    const readMoreText8 = document.getElementById("readMoreText8");

    readMoreButton8.addEventListener("click", function() {
        if (readMoreText8.style.display === "none" || readMoreText8.style.display === "") {
            readMoreText8.style.display = "block";
            readMoreButton2.textContent = "Read Less";
        } else {
            readMoreText8.style.display = "none";
            readMoreButton2.textContent = "Read More";
        }
    });
</script>
...
<script>
    const readMoreButton9 = document.getElementById("readMoreButton9");
    const readMoreText9 = document.getElementById("readMoreText9");

    readMoreButton9.addEventListener("click", function() {
        if (readMoreText9.style.display === "none" || readMoreText9.style.display === "") {
            readMoreText9.style.display = "block";
            readMoreButton9.textContent = "Read Less";
        } else {
            readMoreText9.style.display = "none";
            readMoreButton9.textContent = "Read More";
        }
    });
</script>

<script>
    const readMoreButton10 = document.getElementById("readMoreButton10");
    const readMoreText10 = document.getElementById("readMoreText10");

    readMoreButton10.addEventListener("click", function() {
        if (readMoreText10.style.display === "none" || readMoreText10.style.display === "") {
            readMoreText10.style.display = "block";
            readMoreButton10.textContent = "Read Less";
        } else {
            readMoreText10.style.display = "none";
            readMoreButton10.textContent = "Read More";
        }
    });
</script>

<script>
    const readMoreButton11 = document.getElementById("readMoreButton11");
    const readMoreText11 = document.getElementById("readMoreText11");

    readMoreButton11.addEventListener("click", function() {
        if (readMoreText11.style.display === "none" || readMoreText11.style.display === "") {
            readMoreText11.style.display = "block";
            readMoreButton11.textContent = "Read Less";
        } else {
