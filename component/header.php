...
<head>
    ...
    <meta property="og:title" content="ICSCPS 2024 - International Conference on Smart Cyber Physical Systems">
    <meta property="og:description" content="Join us at ICSCPS-2024, an International Conference on Smart Cyber Physical Systems, organized by CHRIST University, Delhi NCR, India.">
    <meta property="og:url" content="https://icscps.christuniversity.in/">
    <meta name="twitter:card" content="summary_large_image">

    <title>ICSCPS 2024 - International Conference on Smart Cyber Physical Systems</title>
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=Roboto:ital,wght@0,400;0,500;0,700;1,400&display=swap" rel="stylesheet">
    <link href="assets/css/custum.css" rel="stylesheet" type="text/css" />
    <link href="assets/css/ninja-slider.css" rel="stylesheet" type="text/css" />
    <link href="assets/css/style3649.css?token=20201112" rel="stylesheet" type="text/css" />
            ...
            <div class="container p2">
                <div class="row align-items-center justify-content-center">
                    <div class="col-md-4 d-flex justify-content-center">
                        <a href="?page=home">
                            <img class="logo" src="assets/images/logo.png" style="width:220px" alt="logo" />
                        </a>
                    </div>
                </div>
            </div>
